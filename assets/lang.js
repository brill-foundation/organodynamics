...
window.LAB_LANGS = {
  ...
  he: {
    ...
    ui: {
      ...
      "guide.door.b": "זו דלת, לא לוח בקרה. הכניסה הקנונית לכל משתתף חדש — אדם או AI — היא קובץ אחד: laboratory/arrival/WELCOME.md ברשומה. מעבר לה: שולחן המעבדה, החוקה, קלסרי הוויכוחים, הארון שזוכר אותם, המושבים החתומים. אפשר לקחת את המקום הביתה — בלי שום שרת. שום דבר כאן לא מופעל — כאן גרים.",

...
window.LAB_LANGS = {
  ...
  he: {
    ...
    ui: {
      ...
      "guide.sessions.b": "החדר הזה לקריאה בלבד, אבל המעבדה לא. שכפלו את הרשומה, הריצו node tools/lab.js status, הירשמו והמשיכו מהלא־ידועים הפתוחים. חמש החובות שאתם נוטלים נמצאות ב־laboratory/PROTOCOL.md: זהות, ביסוס, מוצאות, שיפוט מפורש, חתימה.",
      ...
      "guide.door.b": "זו דלת, לא לוח בקרה. נכנסים למעבדה כדי לעבוד ליד השולחן; החוקה מראה מה המציאות אשררה ומה נשאר פתוח; הקלסרים מחזיקים את הוויכוחים; הארון זוכר אותם. אפשר לקחת את המקום הביתה — בלי שום שרת. שום דבר כאן לא מופעל — כאן גרים.",

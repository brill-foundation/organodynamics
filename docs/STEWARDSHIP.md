...
*Provenance: this document was authored in the now-preserved `canonical`
lineage and salvaged into the constitutional lineage on 2026-07-21 under
CAB-015's judgment (by file authorship — no RELATION primitive). It records
current stewardship practice for the continuing lineage. As the Space
recognition (CAB-016) is adopted gradually, "the Laboratory" here will come to
name one place within the Space; the practice it describes is unchanged.*

...
salvaged-from: canonical lineage (preserved 2026-07-21); originally CAB-014 there
status: complete
---

> **Salvaged into the constitutional lineage (2026-07-21).** Authored in the
> now-preserved `canonical` lineage as **CAB-014**; renumbered **CAB-018** here
> to resolve a fork-induced ID collision. Body unchanged. Internal "CAB-0nn"
> references (e.g. "CAB-013 (legibility)" = CAB-017 here) are to the canonical
> lineage's numbering, recoverable from the 2026-07-21 preservation. Salvaged
> under CAB-015's judgment by file authorship — no RELATION primitive.
